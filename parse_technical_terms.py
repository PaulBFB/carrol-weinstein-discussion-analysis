...
class Concept(BaseModel):
    concept_name: str = Field(description="the name of concept from physics or mathematics mentioned in the text")
    explanation_of_concept: str = Field(description="a brief explanation of what the concept is")
    education_level: str = Field(description="the expected level of education at which students are exposed to the concepts for the first time")
...
def get_structured_response(text_to_analyze: str, pydantic_response_model: BaseModel = ResponseModel):
    ...
    Analyze the provided transcript for physics or mathematics concepts and respond with this exact JSON structure:
...
if __name__ == "__main__":
    ...
    topics = get_structured_response(test_text)
